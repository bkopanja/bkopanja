...
<!-- BLOG-POST-LIST:START -->> [{{ Open Data Hackathon – what it really is? }}] ({{ url }}) on {{ Fri Dec 11 2015 7:47 PM }}> [{{ GWT problems with Win8 }}] ({{ url }}) on {{ Sun Sep 08 2013 2:26 PM }}> [{{ New decisions for this year }}] ({{ url }}) on {{ Sat Feb 02 2013 2:22 PM }}> [{{ Set Time Machine to use network drive }}] ({{ url }}) on {{ Thu Jan 10 2013 2:05 PM }}> [{{ Look in the past }}] ({{ url }}) on {{ Wed Jan 09 2013 1:56 PM }}<!-- BLOG-POST-LIST:END -->
